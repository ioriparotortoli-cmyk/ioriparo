...
export const AZIENDA = {
  ...
  descrizione:
    'Centro di assistenza tecnica per smartphone, tablet, computer e notebook, recupero dati, videosorveglianza, reti aziendali e impianti Wi-Fi ad Altamura e in provincia di Bari.',
  ...
  fondata: 2013,
  mappa: 'https://www.google.com/maps/search/?api=1&query=Io+Riparo+Altamura',
  social: {
